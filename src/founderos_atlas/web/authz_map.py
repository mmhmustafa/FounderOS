...
ENDPOINT_PERMISSIONS: dict[str, str] = {
    ...
    # AI (PR-165 PRISM): anyone may SEE what AI is enabled and what is
    ...
    "api_prism_diagnostics": SYSTEM_ADMIN,
    # The Playground spends provider tokens on pasted text and exposes
