...
Define the Prompt Pack Manifest schema postponed by PR-004, including immutable template references, variables, input/output schema references, safety/data-handling metadata, and deterministic validation. Do not render prompts or integrate Providers.
