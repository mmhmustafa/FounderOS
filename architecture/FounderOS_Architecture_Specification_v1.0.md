...
The CLI uses a hardened single-Project file store. Founder Setup and deterministic Discovery v1 are executable. Database-grade persistence, generalized workflow execution, AI providers, Validation, and later lifecycle modules remain planned.
